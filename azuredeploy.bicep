...
@description('Git repository URL for the chat application. This defaults to the [`azure-samples/cosmosdb-chatgpt`](https://github.com/ManjulaChintharla/cosmosdb-chatgpt.git) repository.')
param appGitRepository string = 'https://github.com/ManjulaChintharla/cosmosdb-chatgpt.git'

@description('Git repository branch for the chat application. This defaults to the [**main** branch of the `azure-samples/cosmosdb-chatgpt`](https://github.com/ManjulaChintharla/cosmosdb-chatgpt/tree/main) repository.')
